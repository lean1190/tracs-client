...
(function () {
    ...
    PatientWallController.$inject = ["$scope", "$stateParams", "$interval", "$cordovaToast", "PatientFactory", "SocketService", "$state"];

    function PatientWallController($scope, $stateParams, $interval, $cordovaToast, PatientFactory, SocketService,$state ) {
